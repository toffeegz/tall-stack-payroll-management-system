...
class CreateSssContributionRatesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sss_contribution_rates', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('sss_contribution_rates');
    }
}
