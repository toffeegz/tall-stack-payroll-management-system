                ...
                <div class="mt-6 flex-auto text-black text-sm" style="font-weight: 600;">
                    <ul class="space-y-1">
                        ...
                        @if(Auth::user()->hasRole('administrator'))
                            <li class="px-4">
                                <a class="px-6 py-3 inline-flex items-center w-full transition-colors duration-150 hover:text-stone-500 rounded-full @isset($menu) @if($menu == 'employee') bg-stone-100 text-stone-500 @endif @endisset " href="index.html">
                        ...
                        @if(Auth::user()->hasRole('administrator'))
                            <li class="px-4">
                                <a class="px-6 py-3 inline-flex items-center w-full transition-colors duration-150 hover:text-stone-500 rounded-full @isset($menu) @if($menu == 'project') bg-stone-100 text-stone-500 @endif @endisset " href="index.html">
                        ...
                        {{-- report --}}
                        <li class="px-4">
                            <a class="px-6 py-3 inline-flex items-center w-full transition-colors duration-150 hover:text-stone-500 rounded-full @isset($menu) @if($menu == 'report') bg-stone-100 text-stone-500 @endif @endisset " href="index.html">
                        ...
                        {{-- settings --}}
                        @if(Auth::user()->hasRole('administrator'))
                            <li class="px-4" x-data="{ settings: false }">
                                <button class="px-6 py-3 flex justify-between items-center w-full transition-colors duration-150 font-semibold hover:text-stone-500 rounded-full @isset($menu) @if($menu == 'in-and-out' || $menu == 'time-logs' || $menu == 'timesheet') bg-stone-100 text-stone-500 @endif @endisset "
                                ...
                                <template x-if="settings">
                                    <ul
                                        ...
                                        x-transition:leave-start="opacity-100 max-h-xl"
                                        x-transition:leave-end="opacity-0 max-h-0"
                                        class="p-2 space-y-2 overflow-hidden text-stone-500 " style="font-weight: 500;"
                                        aria-label="submenu" >

                                        <li class="px-6 py-1 transition-colors duration-150 hover:text-stone-900" >
                                            <a class="flex" href="#">
