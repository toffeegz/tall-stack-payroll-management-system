<div>
    ...
    <div class="h-full overflow-y-auto">
        <div class="container px-6 mx-auto grid">
          ...
          <!-- CTA -->
          <a
            class="flex items-center justify-between p-4 mb-8 text-sm font-semibold text-stone-100 bg-stone-900 rounded-lg shadow-md focus:outline-none focus:shadow-outline-stone"
              ...
              <span class="flex col-span-4 mt-2 sm:mt-auto sm:justify-end">
                <nav aria-label="Table navigation">
                  <ul class="inline-flex items-center">
                    ...
                    <li>
                      <button
                        class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-stone"
                      >
                        1
                      </button>
                    </li>
                    ...
                    <li>
                      <button
                        class="px-3 py-1 text-white transition-colors duration-150 bg-stone-600 border border-r-0 border-stone-600 rounded-md focus:outline-none focus:shadow-outline-stone"
                      >
                        3
                      </button>
                    </li>
          ...
          <div class="grid gap-6 mb-8 md:grid-cols-2">
            ...
            >
              ...
              >
                ...
                <div class="flex items-center">
                  <span
                    class="inline-block w-3 h-3 mr-1 bg-stone-500 rounded-full"
                  ></span>
                  <span>Shirts</span>
                </div>
                <div class="flex items-center">
                ...
                <div class="flex items-center">
                  <span
                    class="inline-block w-3 h-3 mr-1 bg-stone-600 rounded-full"
                  ></span>
                  <span>Bags</span>
                </div>
              </div>
