    ...
    <div class="grid grid-cols-2 gap-4">
        ...
        <div class="col-span-2 md:col-span-1">
            <div class="flex justify-between">
                ...
                <button onclick="modalObject.closeModal('modalAddLeaveType')" class="text-blue-500 flex items-center justify-center px-2 py-2 cursor-pointer text-xs">
                    ...
                    <table class="w-full whitespace-no-wrap">
                        ...
                        <tbody class="bg-white divide-y "  >
                            @foreach($leave_types as $leave_type)
                                <tr class="text-stone-700 cursor-pointer"  wire:click="openEditLeaveType({{ $leave_type->id }})">
        ...
        <div class="col-span-2 md:col-span-1">
            ...
            <div class="flex justify-between">
                ...
                <button onclick="modalObject.closeModal('modalAddHoliday')" class="text-blue-500 flex items-center justify-center px-2 py-2 cursor-pointer text-xs">
                ...
                <div class="w-full overflow-x-auto">
                    <table class="w-full whitespace-no-wrap">
                        ...
                        <tr class="text-xs font-semibold tracking-wide text-left text-stone-500 uppercase border-b  bg-stone-50 ">
                            ...
                            <th class="px-4 py-3">Name</th>
                            <th class="px-4 py-3 text-center">Days</th>
                            <th class="px-4 py-3 text-right">Legal</th>
                        </tr>
                        </thead>
                        <tbody class="bg-white divide-y "  >
                            @foreach($holidays as $holiday)
                                <tr class="text-stone-700 cursor-pointer" >
                                    ...
                                    <td class="px-4 py-3 text-sm  flex justify-end">
                                        <div class="form-check form-switch">
                                            @livewire('components.toggle-button', ['field' => 'is_legal', 'model' => $holiday], key($holiday->id))
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
