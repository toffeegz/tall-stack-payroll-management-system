<table width="100%" border="0" cellpadding="2" cellspacing="1" style="width:836pt; line-height:16pt; text-decoration:underline;">
    ...
    <tr><td style="border:none; font-size:12pt; font-weight: bold; text-align: center;" colspan="20">Employee List Report</td></tr>
    ...
    {{--  --}}
    <tr>
        <td colspan="20" style="font-size:12pt; font-weight: bold; ">
            @if($data['user_type'] == 2 && $data['project'] != "")
    ...
    <tbody>
        @if($data['user_type'] == "" || $data['user_type'] == 1)
        ...
        @else 
            @if($data['project'] != "")
                ...
                @endforeach
            @else
                @foreach($collection as $projects)
                    <tr>
                        <td colspan="26" style="border:1px solid #000; font-size:12pt; font-weight: bold; ">Project: {{ $projects->name }}</td>
                    </tr>
