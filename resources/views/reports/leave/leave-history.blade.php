<table width="100%" border="0" cellpadding="2" cellspacing="1" style="width:836pt; line-height:16pt; text-decoration:underline;">
    ...
    <tr><td style="border:none; font-size:12pt; font-weight: bold; text-align: center;" colspan="14">Leave History</td></tr>
    ...
    <tr>
        <td rowspan="2" colspan="2" style="border:1px solid #000; font-size:12pt; font-weight: bold; text-align: left;">Employee</td>
        <td rowspan="2" colspan="1" style="border:1px solid #000; font-size:12pt; font-weight: bold; text-align: center;">ID</td>
    ...
    @foreach($data as $value)
        ...
        <tr>
            <td colspan="2" style="text-align: left;">{{ $value->user->formal_name() }}</td>
            <td colspan="1" style="text-align: center;">{{ $value->user->code }}</td>
            ...
            <td colspan="3" style="text-align:left;">{{ $value->reason }}</td>
        </tr>
    @endforeach
</table>