<table width="100%" border="0" cellpadding="2" cellspacing="1" style="width:836pt; line-height:16pt; text-decoration:underline;">
    ...
    <tr><td style="border:none; font-size:12pt; font-weight: bold; text-align: center;" colspan="12">Tax Contribution Report ({{ $data['frequency_id'] == 1 ? 'Semi-Monthly':'Weekly'}})</td></tr>
        <tr>
